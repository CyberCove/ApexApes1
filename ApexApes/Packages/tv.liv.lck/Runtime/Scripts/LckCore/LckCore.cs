...
namespace Liv.Lck.Core
{
    ...
    public static class LckCore
    {
        ...
        public static Result<bool> Initialize(string trackingId, GameInfo gameInfo, LckInfo lckInfo)
        {
            ...
            var result = LckCoreNative.initialize(trackingIdPtr, ffiGameInfo, ffiLckInfo);
        ...
        {
            LckCoreNative.log(level, InteropUtilities.StringToUTF8Pointer(message), InteropUtilities.StringToUTF8Pointer(memberName), InteropUtilities.StringToUTF8Pointer(filePath), lineNumber);
        }
